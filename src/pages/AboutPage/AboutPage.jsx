    ...
    <div className="about-page">
      <div className="about-container">
        ...
        <section className="about-section mission-card">
          ...
          <p>
            Queremos dar visibilidade ao talento local em Moçambique que muitas vezes 
            não recebe o reconhecimento merecido. Acreditamos que cada jogo conta 
            e cada jogador tem uma história.
          </p>
        </section>
        ...
        <section className="about-section dev-card">
          <div className="dev-header">
            ...
            <div className="dev-avatar">
              <img src="/src/images/your-photo.jpg" alt="Developer" onError={(e) => e.target.style.display='none'} />
              <span className="dev-initials">DEV</span> 
            </div>
            <div>
              <h3>Desenvolvido por [Seu Nome]</h3>
              <p className="dev-role">Full Stack Developer • Apaixonado por Desporto</p>
            </div>
          </div>

          <p className="dev-bio">
            Sou um desenvolvedor web focado em criar soluções modernas e rápidas. 
            Estou disponível para projetos freelance e oportunidades profissionais.
          </p>
          ...
          <div className="dev-links">
            <a href="https://linkedin.com/in/seu-perfil" target="_blank" rel="noreferrer" className="btn-link">
              LinkedIn
            </a>
            <a href="https://github.com/seu-user" target="_blank" rel="noreferrer" className="btn-link">
              GitHub
            </a>
        ...
        <section className="about-section">
          ...
          <p>É gratuito! Envie-nos o logótipo e a lista de jogadores através de:</p>
        ...
        <section className="about-section donation-section">
          ...
          <p>Este projeto é mantido de forma independente. Qualquer contribuição ajuda a pagar os servidores.</p>
