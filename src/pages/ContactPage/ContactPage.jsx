...
const contactInfo = {
  email: "raimundroid@gmail.com",
  phone: "+258 87 820 3004",
  whatsapp: "258878203004", // WhatsApp number (no + or spaces)
  whatsappDisplay: "+258 87 820 3004", // Display format
  facebook: "https://www.facebook.com/profile.php?id=61584955900976", // Full Facebook page URL
  whatsappChnanel: "https://whatsapp.com/channel/0029VbC0BUKCHDyg2YTpu521", // Full WhatsApp Channel page URL
};
  ...
  return (
    <div className="contact-page">
      <div className="contact-content">
        {/* icon="📞" */}
        <PageIndicator icon=<PhoneSVG /> title="Contacte-nos" />
        ...
        <div className="contact-cards">
          ...
          */}
          ...
          >
            ...
            <div className="contact-card__content">
              <h3 className="contact-card__title">Email (Desenvolvedor)</h3>
          ...
          */}
          ...
          >
            ...
            <div className="contact-card__content">
              <h3 className="contact-card__title">Página do Facebook</h3>
              <p className="contact-card__value">ManingueBola</p>
          ...
          */}
          ...
          <a
            href={contactInfo.whatsappChnanel}
            className="contact-card"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <div className="contact-card__content">
              <h3 className="contact-card__title">Canal de WhatsApp</h3>
              <p className="contact-card__value">ManingueBola⚽</p>
              <span className="contact-card__action">Visitar canal →</span>
            </div>
          </a>
        </div>
        ...
        <div className="contact-footer">
          <div className="info-box">
            ...
            <p className="info-box__text">
              Respondemos a todas as mensagens o mais rápido possível, todos os
              dias da semana.
            </p>
          </div>
          ...
          <div className="info-box">
            ...
            <p className="info-box__text">
              Para um atendimento mais rápido, faça por ligação telefónica ou
              via SMS.
            </p>
          </div>
        </div>
